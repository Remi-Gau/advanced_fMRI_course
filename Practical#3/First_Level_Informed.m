...
AnalysisFolder = strcat(pwd, filesep, 'Analysis_Informed', filesep);

if exist(strcat('Analysis_Informed'), 'dir') == 0
    mkdir Analysis_Informed;
end
...
save (strcat('First_Level_Informed_jobs'));
